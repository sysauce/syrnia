...
if($alwaysDesktop==1){
	$_SESSION['AlwaysShowDesktopSite']=true;
}
if($_SESSION['AlwaysShowDesktopSite']!=true){
	require_once('mobile_device_detect.php');
	mobile_device_detect(true,false,true,true,true,true,true,'mobile.php' . ($page ? "?page=$page" : ""). ($code ? "?code=$code" : ""). ($username ? "?username=$username" : ""),false);
}
...
pageTracker._trackPageview();
  ...
  <body topmargin=0 leftmargin=0 rightmargin=0 bottommarin=0><table border=0 cellpadding=0 cellspacing=1 width="100%" height="100%">
...
</td><td width=920 background=layout/newdesign/bg1.jpg>

<table border=0 cellpadding=0 cellspacing=0 width="920" height="100%">
<tr valign=top><td background=layout/newdesign/siteoverlayZwart.png align="center">
...
<tr align="center"><td>
	...
	<?php echo MakeButton("News", "?page=forum&action=viewcat&cat=13440", 120, ""); ?>
</td><td>
...
$vote == 'toprpggames'))
{
    ...
    if ($uid)
    {
        ...
        if ($aantal == 0)
        {
            ...
            echo "You have succesfully voted";
...
<span class=footerText>&copy; <?php echo date(Y); ?> M2H - <a href="mobile.php" style="color:white;">Mobile version</a> -  <a href="http://www.Wooglie.com" title="Unity games" style="color:white;">3D games</a> </span><br />
