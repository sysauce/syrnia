...
# along with Mantis.  If not, see <http://www.gnu.org/licenses/>.
	...
	$g_password_confirm_hash_magic_string = 'blowfsdfssd\ffsish';
	...
	# --- email variables -------------
	$g_administrator_email	= 'support@syrnia.com';
	$g_webmaster_email		= 'support@syrnia.com';

	# the sender email, part of 'From: ' header in emails
 	$g_from_email			= 'support@syrnia.com';
	
	# the sender name, part of 'From: ' header in emails
	$g_from_name			= 'Syrnia - Mantis Bug Tracker';

	# the return address for bounced mail
	$g_return_path_email	= 'support@syrnia.com';
	...
	# --- sitewide variables ----------
	$g_window_title			= 'Syrnia - Mantis';	 # browser window title
